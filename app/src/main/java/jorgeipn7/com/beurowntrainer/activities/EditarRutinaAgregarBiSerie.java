...
public class EditarRutinaAgregarBiSerie extends AppCompatActivity {

            CoordinatorLayout coordinator_layout_agregar_bi_serie;
            ...
            private boolean FLAG_CREATE_RUTINA;
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.activity_editar_rutina_agregar_bi_serie);
                Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
                setSupportActionBar(toolbar);

                showToolbar("Agregar Ejercicio", true);
                FLAG_CREATE_RUTINA = true;
                coordinator_layout_agregar_bi_serie = (CoordinatorLayout) findViewById(R.id.coordinator_layout_agregar_bi_serie);
...
//                dialogo();
                ...
                //RecyclerView
                recyclerView = (RecyclerView) findViewById(R.id.recyclerview_agregar_bi_serie);
                recyclerViewMusculo = (RecyclerView) findViewById(R.id.recyclerview_ejercicios_dia_rutina_musculos_bi_serie);
            ...
            private void addEjercicio(Ejercicio ejercicio){
                ...
                if( FLAG_CREATE_RUTINA ){
                    Log.d("Insert", "Rutina1: " + series1 + ", " + series2 + ", " + repeticiones1 + ", " + repeticiones2 + ", " + peso1 + ", " + peso2 + ", " + descansoSerie + ", " + descansoFinal + ", " + descansoBiSerie  );
                    ...
                    Log.d("Insert", "Rutina1. Num Ejercicios: " +  rutinaBD.getLastIdInserted().getEjercicios().size());
                    Log.d("Insert", "Ejercicio1" + ejercicio.getId() + " - " + getResources().getString(ejercicio.getNombre()));
                    rutinaBD.updateRutinaAddEjercicio(rutinaBD.getLastIdInserted(), ejercicio);

                    rutinaAUX= rutinaBD.getLastIdInserted();
                    this.FLAG_CREATE_RUTINA= false;
                } else if( FLAG_CREATE_RUTINA == false){
                    Log.d("Insert", "Rutina2. Num Ejercicios: " +  rutinaBD.getLastIdInserted().getEjercicios().size());
                    Log.d("Insert", "Rutina2: " + series1 + ", " + series2 + ", " + repeticiones1 + ", " + repeticiones2 + ", " + peso1 + ", " + peso2 + ", " + descansoSerie + ", " + descansoFinal + ", " + descansoBiSerie  );

                    Log.d("Insert", "Ejercicio2" + ejercicio.getId() + " - " + getResources().getString(ejercicio.getNombre()));
                    rutinaBD.updateRutinaBiSerie(rutinaAUX, new Rutina( series1, series2, repeticiones1, repeticiones2, peso1, peso2, descansoSerie, descansoFinal, descansoBiSerie) );
                    rutinaBD.updateRutinaAddEjercicio(rutinaBD.getLastIdInserted(), ejercicio);
            ...
            private void dialogo() {
                ...
                ti_descanso_final = (TextInputLayout) dialogAgregarNewEjercicio.findViewById(R.id.ti_descanso_final);
                ti_descanso_serie = (TextInputLayout) dialogAgregarNewEjercicio.findViewById(R.id.ti_descanso_serie);
                ...
                if (FLAG_CREATE_RUTINA){
                    ...
                    ti_descanso_serie.setHint(getResources().getString(R.string.dialogo_agregar_ejercicio_descanso_biserie));

                } else{
                    ti_descanso_final.setVisibility(View.VISIBLE);
                    ti_descanso_serie.setHint(getResources().getString(R.string.dialogo_agregar_ejercicio_descanso_bi_serie));
                }
//------------------------------------------------------------------------------------------------------------------------------------------------------
